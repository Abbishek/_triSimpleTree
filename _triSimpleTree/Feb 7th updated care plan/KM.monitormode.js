...
//var GlobalVarPatientId = parent.Xrm.Page.data.entity.getId();
...
$(document).ready(function () {
    ...
    $('.maintable_symptoms_all,.maintable_symptoms_red,.maintable_symptoms_orange,.maintable_symptoms_green, .maintable_symptoms_grey,.maintable_testcare_all,.maintable_testcare_red,.maintable_testcare_orange,.maintable_testcare_green, .maintable_testcare_grey,.maintable_vitals_all,.maintable_vitals_red,.maintable_vitals_orange,.maintable_vitals_green, .maintable_vitals_grey,.maintable_medications_all,.maintable_medications_red,.maintable_medications_orange,.maintable_medications_green, .maintable_medications_grey,.maintable_activity_all,.maintable_activity_red,.maintable_activity_orange,.maintable_activity_green, .maintable_activity_grey,.maintable_nutrition_all, .maintable_nutrition_red,.maintable_nutrition_orange,.maintable_nutrition_green, .maintable_nutrition_grey,.maintable_psychosocial_all, .maintable_psychosocial_red,.maintable_psychosocial_orange,.maintable_psychosocial_green, .maintable_psychosocial_grey, .maintable_wrapup_all, .maintable_wrapup_red,.maintable_wrapup_orange,.maintable_wrapup_green, .maintable_wrapup_grey').on("click", "td", function () {
        ...
        if ($(this).text() === "...") {
           ...
           // $('.goalhistory-filtergoal').attr('id', currentId + "_powerbi");
            
            ReviewAndUpdateGoal(currentId);
            $('.window-wrapper').attr('id', currentId);
        }
    });
...
function ReviewAndUpdateGoal(currentId) {
  ...
  function (result) {
     ...
     // alert(contactId);
      ...
      $('.personalizenormalmultiplier').val(tri_activityrecurrencemultipliernormal).spinner({ step: 1.00, numberFormat: "n" });
      $('.personalizeabnormalmultiplier').val(tri_activityrecurrencemultiplierabnormal).spinner({ step: 1.00, numberFormat: "n" });
              ...
              //<!-- FACTOR DROP-DOWN -->    
                ...
                '</ul>' +
                  ...
                  '</td></tr>' +
                    ...
                    '</td >' +
                    '<td width="220px">' + //
                    '<input  type="text" class="txtfieldquantitative" style="width:40px; padding: 6px; border-color:transparent;" id=' + vVitalFactorMULTIPLIER_NORMALId + '>' + //multiplier for normal reading
                    //<!-- MODIFIER DROP-DOWN -->    
                  ...
                  '</div>' +
                  '</td>' +
                    '<td width="220px"> <input type="text" class="txtfieldquantitative" style="width:40px; padding: 6px; border-color:transparent;" id=' + vVitalFactorMULTIPLIER_ABNORMALId + '>' +    //table2 column6, multiplier for abnormal reading
                     //<!-- MODIFIER DROP-DOWN -->    
                    '<div class="btn-group" style="width:60px;">' +
              ...
              //<!-- FACTOR DROP-DOWN -->    
                ...
                '</ul>' +
                  ...
                  '</td></tr>' +
                    ...
                    '</td >' +
                    '<td width="220px">' + //
                    '<input  type="text" class="txtfieldquantitative" onmouseover ="dynamicToolTip(this)" style="width:40px; padding: 6px; border-color:transparent;" id=' + vVitalFactorMULTIPLIER_NORMALId + '>' + //multiplier for normal reading
                    //<!-- MODIFIER DROP-DOWN -->    
                    '<div class="btn-group" style="width:60px;">' +
                    '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id=' + vVitalFreqNormalButtonId + '><span class="caret"></span></button>' +
                    '<ul class="dropdown-menu" id=' + vVitalFreqNormalULId + '>' +
        ...
        SDK.JQuery.retrieveRecord(
           tri_PatientModifierId.Id,
            ...
            function (result) {
                ...
                $("#" + vMULTIPLIER_NORMALselector).spinner({ step: 1.00, numberFormat: "n" });//append  metric
                ...
                $("#" + vMULTIPLIER_ABNORMALselector).spinner({ step: 1.00, numberFormat: "n" });//append  metric
...
function (results) {
    if (results.length > 0) {
        ...
        if (strWrapper === "window") {
            ...
            $('.personalizenormalmultiplier').spinner({ step: 1.00, numberFormat: "n" });//append  metric

            $('.personalizeabnormalmultiplier').val(tri_activityrecurrencemultiplierabnormal);//append  metric
            $('.personalizeabnormalmultiplier').spinner({ step: 1.00, numberFormat: "n" });;//append  metric
...
function OnSavePrsnlizeClicked() {
    ...
    GetModfrIdFromName(vVitalTypId1, contactId1, vModfrName1, vOsetValMetricOperator1, vTargetValueTxt1, vOsetValFreqNormal1, vOsetValFreqAbNormal1, "", vMultiplierNormalTxt1, vMultiplierAbormalTxt1, vTargetValue2Txt1, vQualTxt1, vOsetValMetricOperator21, vOsetValGoalState1, vobservedValue, vLastResultDate, vinRangeEncounterDate, voutRangeEncounterDate);
    ...
    function (result) {
        ...
        $('.slider').slider({
            ...
            stop: function (event, ui) {
                ...
                var currTxbxId = "observedValue";
                var strV1 = $('.slider').data("sldrdata").v1.toString();
                var strV1txt = $('.slider').data("sldrdata").v1txt.toString();
                var strV2 = $('.slider').data("sldrdata").v2.toString();
                var strV2txt = $('.slider').data("sldrdata").v2txt.toString();
                var strV3 = $('.slider').data("sldrdata").v3.toString();
                var strV3txt = $('.slider').data("sldrdata").v3txt.toString();
                var strV4 = $('.slider').data("sldrdata").v4.toString();
                var strV4txt = $('.slider').data("sldrdata").v4txt.toString();
                var strV5 = $('.slider').data("sldrdata").v5.toString();
                var strV5txt = $('.slider').data("sldrdata").v5txt.toString();
                var strV6 = $('.slider').data("sldrdata").v6.toString();
                var strV6txt = $('.slider').data("sldrdata").v6txt.toString();
                var strV7 = $('.slider').data("sldrdata").v7.toString();
                var strV7txt = $('.slider').data("sldrdata").v7txt.toString();
                var strV8 = $('.slider').data("sldrdata").v8.toString();
                var strV8txt = $('.slider').data("sldrdata").v8txt.toString();
                var strV9 = $('.slider').data("sldrdata").v9.toString();
                var strV9txt = $('.slider').data("sldrdata").v9txt.toString();
                var hex1 = $('.slider').data("sldrdata").v1color.toString();
                var hex2 = $('.slider').data("sldrdata").v2color.toString();
                var hex3 = $('.slider').data("sldrdata").v3color.toString();
                var hex4 = $('.slider').data("sldrdata").v4color.toString();
                var hex5 = $('.slider').data("sldrdata").v5color.toString();
                var hex6 = $('.slider').data("sldrdata").v6color.toString();
                var hex7 = $('.slider').data("sldrdata").v7color.toString();
                var hex8 = $('.slider').data("sldrdata").v8color.toString();
                var hex9 = $('.slider').data("sldrdata").v9color.toString();
                var goal1 = $('.slider').data("sldrdata").v1goal.toString();
                var goal2 = $('.slider').data("sldrdata").v2goal.toString();
                var goal3 = $('.slider').data("sldrdata").v3goal.toString();
                var goal4 = $('.slider').data("sldrdata").v4goal.toString();
                var goal5 = $('.slider').data("sldrdata").v5goal.toString();
                var goal6 = $('.slider').data("sldrdata").v6goal.toString();
                var goal7 = $('.slider').data("sldrdata").v7goal.toString();
                var goal8 = $('.slider').data("sldrdata").v8goal.toString();
                var goal9 = $('.slider').data("sldrdata").v9goal.toString();
                ...
                if (strCurrval == strV1) {
                    $("#" + currTxbxId).val(strV1txt)
                    $(this).css("background-color", "#" + hex1);
                    SliderSetGoalState(goal1);
                };
                if (strCurrval == strV2) {
                    $("#" + currTxbxId).val(strV2txt);
                    $(this).css("background-color", "#" + hex2);
                    SliderSetGoalState(goal2);
                };
                if (strCurrval == strV3) {
                    $("#" + currTxbxId).val(strV3txt);
                    $(this).css("background-color", "#" + hex3);
                    SliderSetGoalState(goal3);
                };
                if (strCurrval == strV4) {
                    $("#" + currTxbxId).val(strV4txt);
                    $(this).css("background-color", "#" + hex4);
                    SliderSetGoalState(goal4);
                };
                if (strCurrval == strV5) {
                    $("#" + currTxbxId).val(strV5txt);
                    $(this).css("background-color", "#" + hex5);
                    SliderSetGoalState(goal5);
                };
                if (strCurrval == strV6) {
                    $("#" + currTxbxId).val(strV6txt);
                    $(this).css("background-color", "#" + hex6);
                    SliderSetGoalState(goal6);
                };
                if (strCurrval == strV7) {
                    $("#" + currTxbxId).val(strV7txt);
                    $(this).css("background-color", "#" + hex7);
                    SliderSetGoalState(goal7);
                };
                if (strCurrval == strV8) {
                    $("#" + currTxbxId).val(strV8txt);
                    $(this).css("background-color", "#" + hex8);
                    SliderSetGoalState(goal8);
                };
                if (strCurrval == strV9) {
                    $("#" + currTxbxId).val(strV9txt);
                    $(this).css("background-color", "#" + hex9);
                    SliderSetGoalState(goal9);
                };
...
function SliderSetGoalState(osetValue) {
...
function gotoBulkEdit() {
    ...
    var vContactId1 = parent.Xrm.Page.data.entity.getId();
    var vContactId2 = vContactId1.replace("{", "");
    var vContactId = vContactId2.replace("}", "");
    //var vEntityName = parent.Xrm.Page.data.entity.getEntityName();

    Xrm.Utility.openWebResource("tri_html/BulkUpdateGoalsGrid.html?Data="+vContactId, null, 1300, 1300);
   
}

function gotoGoalHistoryFilterContact() {
    ...
    //var vEntityName = parent.Xrm.Page.data.entity.getEntityName();
    //alert(vContactId);
    Xrm.Utility.openWebResource("tri_html/GoalHistory.html?Data=contactid%3D" + vContactId, null, 1200, 1200);

}

function gotoGoalHistoryFilterGoal() {
