...
function getCPGoalSymptomsAll(PatientId) {
    ...
    function () {
        ...
        if (intTotalSymptoms === null || intTotalSymptoms === undefined) {
            $('.indicator-box-small_symptoms_all').hide();
        }
    }
);
    ...
    SDK.JQuery.retrieveMultipleRecords(
        ...
        function () {
            ...
            if (intTotalvitalsMet === null || intTotalvitalsMet === undefined) {
                $('.indicator-box-big_vitals_green').hide();
            }
        }
    );
}
    ...
    SDK.JQuery.retrieveMultipleRecords(
        ...
        function () {
            ...
            if (intTotalvitalsOverDue === null || intTotalvitalsOverDue === undefined) {
                $('.indicator-box-big_vitals_grey').hide();
            }
        }
    );
}
    ...
    SDK.JQuery.retrieveMultipleRecords(
     ...
     function () {
         ...
         if (intTotalmedicationsNotMet === null || intTotalmedicationsNotMet === undefined) {
             $('.indicator-box-big_medications_red').hide();
         }
     }
 );
}
    ...
    SDK.JQuery.retrieveMultipleRecords(
      ...
      function () {
          ...
          if (intTotalmedicationsOpen === null || intTotalmedicationsOpen === undefined) {
              $('.indicator-box-big_medications_orange').hide();
          }
      }
  );
}
    ...
    SDK.JQuery.retrieveMultipleRecords(
        ...
        function () {
            ...
            if (intTotalmedicationsMet === null || intTotalmedicationsMet === undefined) {
                $('.indicator-box-big_medications_green').hide();
            }
        }
    );
}
    ...
    if (personId !== null && personId !== "") {
        ...
        function (results) {
            for (var i = 0; i < results.length; i++) {
                ...
                var vVitalMetricOperatorButtonIdTwo = results[i].tri_vitalsvaluetypeid.Id + "_MTRCOPRTRBTNTWO";
                ...
                var vVitalMetricOperatorULIdTwo = results[i].tri_vitalsvaluetypeid.Id + "_MTRCOPRTRULTWO";// used in PatienModifier dropdown
                ...
                var vVitalFactortargetvaluetwoId = results[i].tri_vitalsvaluetypeid.Id + "_TARGETVALTWO";// used in targetval two textbox
                var vVitalFactorQUALITATIVEId = results[i].tri_vitalsvaluetypeid.Id + "_QUALITATIVETXT";// used in targetval two textbox
                ...
                if (IndexOfVitalType === -1 && IndexOfVitalType !== null && IndexOfVitalType !== undefined) {
                    ...
                    if (vVitalTypeId !== null && vVitalTypeId !== undefined) {
                        modifierList = GetModifierBasedOnValueType(results[i].tri_vitalsvaluetypeid.Id, contactId);
                    }
                    ...
                    switch (results[i].tri_GoalSection.Value) {
                        case 100000000:
                            ...
                            vTblRowsSymptoms = vTblRowsSymptoms +
                                '<br><div class="indicator-wrapper"><div style="height:30px;padding:5px;" class="flag-box-big ' + goalClass + '" style=""> <br> </div><div class="sectiontitle_personalize">' + tri_VitalValueTypeName + '</div><div class="indicator-line  ' + goalClass + '"></div></div>' +  // indicator wrapper div open-closes
