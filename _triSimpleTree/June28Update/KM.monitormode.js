        ...
        function (results) {
         ...
         '</tr></table>' +//table 1 end
          ...
          //<!-- FACTOR DROP-DOWN -->    
            ...
            '<ul class="dropdown-menu" id=' + vVitalFactorULId + '>' + modifierList + '</ul>' +
              '</div>' +
              '</td></tr>' +
         ...
         '<br></td>' +
            ...
            '<tr></tr> <tr><td>' +
                ...
                '<button class="btn btn-primary savebtn" type="button"  id=' + vVitalSaveButtonId + ' disabled="disabled">Save Changes</button>' +
                '</div></div>' +
                '</td></tr></table>' +
            //'<br>'+
