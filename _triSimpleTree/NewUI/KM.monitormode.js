...
function gotoAddCarePlan() {
    ...
    SDK.JQuery.retrieveMultipleRecords(
    "tri_careplanjoin",
    "?$select=tri_GoalSection,new_GoalState,tri_vitalsvaluetypeid,tri_VitalValueTypeName&$filter=tri_PatientID/Id eq (guid'" + contactId + "')&$orderby=tri_GoalSection",
    function (results) {
        for (var i = 0; i < results.length; i++) {
 ...
 '<br></td>' +
    ...
    '</div><br>';//tablecontent div closes here
                    ...
                    case -1:
                        ...
                        //                          '<br><div class="indicator-wrapper"><div class="sectiontitle_personalize">' + tri_VitalValueTypeName + '</div><div class="indicator-line  ' + goalClass + '"></div></div>' +  // indicator wrapper div open-closes
        ...
        vFinalTbl = '<div style="width:100%;padding-bottom:80px;text-align:center;"><div class="x-close">X</div></div>' +
                    '<div style="margin-bottom: 60px;"><div style="margin-top:-30px;">' +
                    '<span style="color: #333333; font-size: 18px; text-align: left;"><h4>Select the Care Plan you want to add:</h4></span></div>' +
                    '<div style="padding-bottom: 20px;"><div class="carePathDropdown" style="float: left;"><input id="carePaths" style="width: 100%;"/></div>' +
