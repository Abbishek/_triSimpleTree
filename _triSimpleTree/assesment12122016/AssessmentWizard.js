                    ...
                    if (j < results.value.length) {
                        if (j === 0) {
                            if (firstView === false) {
                                ...
                                quesAnsHtm = '<div style= "display:block;background: white;border: 0 none;border-radius: 3px;box-shadow: 0 0 15px 1px rgba(0, 0, 0, 0.4);padding: 20px 30px;box-sizing: border-box;width: 80%;margin: 0 10%;position: absolute;">' + '<div style="visibility:hidden;">' + sectionname + '</div>' + questionWithAns + "</div>";
                                ...
                                quesAnsHtm = '<div style ="display:none;background: white;border: 0 none;border-radius: 3px;box-shadow: 0 0 15px 1px rgba(0, 0, 0, 0.4);padding: 20px 30px;box-sizing: border-box;width: 80%;margin: 0 10%;position: absolute;">' + '<div style="visibility:hidden;">' + sectionname + '</div>' + questionWithAns + "</div>";                     
                            }
                        }
                        else {
